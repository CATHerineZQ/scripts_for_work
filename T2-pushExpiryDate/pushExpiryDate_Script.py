...
if __name__ == "__main__":
	...
	original_data1 = raw_input("Please input 1st date in format DD/MM/YYYY: ")
	original_data2 = raw_input("Please input 2nd date in format DD/MM/YYYY: ")
	pushTo_date = raw_input("Please input the date will be pushed to in format DD/MM/YYYY: ")
