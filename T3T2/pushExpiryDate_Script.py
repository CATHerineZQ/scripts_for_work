...
def generate_hpbatch(original_data1, original_data2, pushTo_date):
	...
	for line in fd:
		...
		if len(splited_line) == 34:
		    if (((splited_line[12] == original_data1) or (splited_line[12] == original_data2)) and (splited_line[8] == "2") and (splited_line[0] == "BellMobility" or splited_line[0] == "PCMobile")):
		    	...
		    	push_days = str(9 - int(time.strftime("%w")))
		    	#push_days = "5" # set push_days var, set: Running this script on Thursday and push_days is 5 as default 
...
if __name__ == "__main__":
	...
	yesORno = raw_input("Are the dates above correct? (YES/NO): ")
	if yesORno == "YES":
		original_data1, original_data2, pushTo_date = saturday, sunday, tuesday
	else:
		original_data1 = raw_input("Please input Saturday date in format DD/MM/YYYY: ")
		original_data2 = raw_input("Please input Sunday date in format DD/MM/YYYY: ")
		pushTo_date = raw_input("Please input the Tuesday date will be pushed to in format DD/MM/YYYY: ")
