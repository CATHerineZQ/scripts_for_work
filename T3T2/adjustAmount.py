...
def weedkend_call(info):
	...
	for line in info:
		...
		strline = "RequestPaymentReload_v3|" + br + "|3|1|" + line[2].strip() + "|" + str(int(line[6])*(100)) + "|RST|" + uniq_str + "|||PPDOps|NM1_contingency"
...
def monday_call(info):
	...
	for line in info:
		...
		strline = "RequestAdjustment|" + br + "|3|1|" + line[2].strip() + "|" + str(int(line[6])*(-100)) + "|0|PRPR||PPDOps|NM1_contingency"
